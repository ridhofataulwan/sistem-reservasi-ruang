...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="d-flex flex-shrink-0">
                ...
                <div class="d-flex ms-3">
                    <a href="#"
                        ...
                        data-bs-toggle="modal" data-bs-target="#kt_modal_tambah_acara">
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <!-- list.reservasi.php -->
            <?php echo $this->include('/includes/dashboard/card/list/list.acara.php'); ?>
            <!-- end hello.user.php -->
            <!--end::Row-->
            <!--end::Container-->
        </div>
    ...
    echo $this->include('/includes/dashboard/modals/update.acara.php');
    ?>
    <!--end::Modals-->
