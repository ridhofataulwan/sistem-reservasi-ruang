            ...
            t.querySelectorAll('[data-kt-filemanager-table-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    ...
                    Swal.fire({
                        ...
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: "Konfirmasi Hapus Data!",
            ...
            (t = document.querySelector("#kt_file_manager_list")) &&
                ...
                (() => {
                    ...
                    const o = {
                            ...
                            language: {
                                emptyTable: `<div class="d-flex flex-column flex-center">\n                    <img src="${hostUrl}media/illustrations/sketchy-1/5.png" class="mw-400px" />\n                    <div class="fs-1 fw-bolder text-dark">Data tidak tersedia.</div>\n                    <div class="fs-6">Silahkan menambahkan data baru</div>\n                </div>`,
                            },
                        },
                        n = {
                            info: !1,
                            ...
                            columns: [{ data: "checkbox" }, { data: "name" }, { data: "size" }, { data: "date" }, { data: "action" }],
                            language: {
                                emptyTable: `<div class="d-flex flex-column flex-center">\n                    <img src="${hostUrl}media/illustrations/sketchy-1/5.png" class="mw-400px" />\n                    <div class="fs-1 fw-bolder text-dark mb-4">Data tidak tersedia.</div>\n                    <div class="fs-6">Silahkan menambahkan data baru</div>\n                </div>`,
                            },
                            conditionalPaging: !0,
                        };
                    var r;
