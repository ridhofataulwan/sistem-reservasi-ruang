    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="row gy-5 g-xl-10">
                <!-- hello.user.php -->
                <?php echo $this->include('/includes/dashboard/card/hello.user.php'); ?>
                <!-- end hello.user.php -->
                <!-- reservasi.summary.php -->
                <?php echo $this->include('/includes/dashboard/card/reservasi.summary.php');
                ?>
                <!-- End reservasi.summary.php -->
            </div>
            <!--end::Row-->
            <!--begin::Row-->
            <div class="row gy-5 g-xl-10">
