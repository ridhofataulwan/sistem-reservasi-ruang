...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="d-flex flex-shrink-0">
                ...
                <div class="d-flex ms-3">
                    <a href="#" class="btn btn-flex flex-center bg-body btn-color-gray-700 btn-active-color-primary w-40px w-md-auto h-40px px-0 px-md-6" data-bs-toggle="modal" data-bs-target="#kt_modal_tambah_opd">
                        ...
                        <!--end::Svg Icon-->
                        <span class="d-none d-md-inline">Tambah OPD</span>
                    </a>
                </div>
                <!--end::Tambah OPD-->
            </div>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <!-- list.opd.php -->
            <?php echo $this->include('/includes/dashboard/card/list/list.opd.php'); ?>
            <!-- end hello.user.php -->
            <!--end::Row-->
            <!--end::Container-->
        </div>
    ...
    echo $this->include('/includes/dashboard/modals/tambah.opd.php');
