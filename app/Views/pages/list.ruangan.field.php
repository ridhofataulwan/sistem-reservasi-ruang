...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                ...
                <h1 class="text-dark fw-bolder my-0 fs-2">
                     ...
                     * 
                     * title dapat diubah melalui controller
                     */
                    $title;
                    ?>
                </h1>
            ...
            <div class="d-flex flex-shrink-0">
                <!--begin::Tambah ruangan-->
                <?php if (session()->get('group') != 'user') : ?>
                    <div class="d-flex ms-3">
                        <a href="#" class="btn btn-flex flex-center bg-body btn-color-gray-700 btn-active-color-primary h-40px px-0 px-md-6" data-bs-toggle="modal" data-bs-target="#kt_modal_tambah_ruangan">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                            <span class="svg-icon svg-icon-2 svg-icon-primary me-0 me-md-2 px-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <!-- list.reservasi.php -->
            <?php echo $this->include('/includes/dashboard/card/list/list.ruangan.php'); ?>
            <!-- end hello.user.php -->
            <!--end::Row-->
            <!--end::Container-->
        </div>
    ...
    echo $this->include('/includes/dashboard/modals/tambah.ruangan.php');
